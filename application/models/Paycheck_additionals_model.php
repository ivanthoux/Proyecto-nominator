...
class Paycheck_additionals_model extends Base_model
{

  protected $table = 'paycheck_additionals';
  protected $single_for_view = 'detalle de recibo de sueldo';
  protected $primary_key = 'paycheckadditional_id';
