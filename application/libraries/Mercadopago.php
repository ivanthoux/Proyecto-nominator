...
class Mercadopago
{
    ...
    function __construct($config)
    {
        ...
        $this->callback_success = $config['callback_success'];
        $this->callback_failure = $config['callback_failure'];
        $this->callback_pending = $config['callback_pending'];
        $this->auto_return = $config['auto_return'];

        $this->notification_url = $config['notification_url'];
    ...
    {
        $preference = array_merge($preference, ['notification_url' => $this->notification_url]);
        if ($this->callback_success !== '') {
            $preference = array_merge($preference, [
                'back_urls' => [
                    'success' => $this->callback_success,
                    'failure' => $this->callback_failure,
                    'pending' => $this->callback_pending
                ],
